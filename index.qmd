...
Answer: Zip code should be modelled as a categorical variable and is a non-ordinal variable. The zip code in a numericalordering does not have any inherent relationship to house prices.
...
Answer: While R has a more mature implementation of decision trees, Python's implementation is more flexible and allows for more complex tree structures. R also has a more mature ecosystem of packages for decision tree implementation.
